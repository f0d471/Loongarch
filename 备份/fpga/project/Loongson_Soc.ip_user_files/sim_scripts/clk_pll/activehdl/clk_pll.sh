...
#
# Script generated by Vivado on Thu Mar 05 23:05:51 +0800 2026
...
# script info
echo -e "clk_pll.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/github/Loongarch/LLaMA2-on-OpenLA500/fpga/project/Loongson_Soc.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
...
Usage: clk_pll.sh [-rerun]\n\
Usage: clk_pll.sh [-reset_run]\n\
Usage: clk_pll.sh [-clean]\n\
